...
<div id="overlayForm" class="bg-slate-800 bg-opacity-60  w-full h-full z-[10] flex items-center justify-center backdrop-blur-sm absolute top-0 left-0">
                ...
                <form class=" bg-white w-[600px] rounded-xl p-5 relative" id="formCategory" enctype="multipart/form-data">
                    ...
                    <div>
                        ...
                        <input type="hidden" name="csrf_token" value="<?= $_SESSION['ID_user'] ?>">
                        
                    </div>
                    <div class="py-2">
                        <label for="desc" class="block mb-2 text-sm font-medium ">Tiltle</label>
                        <div class="flex">
                            ...
                            <input type="text" id="nameCategory" name="name" class="rounded-none rounded-e-lg bg-gray-50 border  text-gray-900 focus:ring-blue-500 focus:border-blue-500 block flex-1 min-w-0 w-full text-sm p-2.5      dark:focus:ring-blue-500 " placeholder="Enter title wiki">
                        </div>
                        <span class="text-rose-500 text-sm font-medium" id="nameErr"></span>
                    </div>
                    <div class="py-2">
                        <label for="email" class="block mb-2 text-sm font-medium ">Wiki Content</label>
                        <div class="flex">
    ...
    <div class="flex relative flex-col gap-5 lg:flex-row lg:items-center">
        ...
        <main class=" p-3  flex-grow shadow-lg rounded-lg h-full">
            ...
            <div class="mr-5 absolute top-0 right-0">
                <a href="#" class="inline-flex items-center px-5 py-2 text-sm font-medium text-center text-white bg-primary rounded-lg hover:bg-orange-600 focus:ring-2 focus:outline-none focus:ring-orange-300 ">
...
<script type="module" src="<?php echo URLROOT ?>/js/articles.js"></script>
