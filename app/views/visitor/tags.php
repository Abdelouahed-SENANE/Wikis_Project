...
<div class="container mx-auto px-10 my-5">
    <div class="flex flex-col gap-5 lg:flex-row lg:items-center">
        <aside class="w-full  p-3 lg:w-[200px] shadow-lg rounded-lg">
            ...
            <ul class="my-10">
                <li class=" my-3 ml-2  hover:text-primary hover:bg-slate-100 p-2 rounded-md">
                    <a href="<?= URLROOT ?>/pages/index" class="flex gap-1.5 items-center hover:text-primary">
                ...
                <li class="flex gap-1 items-center ml-2 hover:text-primary hover:bg-slate-100 p-2 rounded-md">
                    <a href="<?= URLROOT ?>/pages/index" class="flex gap-1.5 items-center group  hover:text-primary">
                ...
                <li class="flex gap-1 items-center ml-2 hover:text-primary hover:bg-slate-100 p-2 rounded-md">
                    <a href="<?= URLROOT ?>/pages/index" class="flex gap-1.5 items-center group  ">
        ...
        <main class=" p-3 flex-grow shadow-lg rounded-lg">
            <div class=" py-5">
            ...
            <div id="tags-container" class="my-5 grid gap-5 grid-cols-1 lg:grid-cols-4">
                <!-- <div class="card p-5  shadow-md">
                    <div>
                        <span class="bg-orange-200 py-1.5 px-2 rounded-lg ">.Tag Name</span>
