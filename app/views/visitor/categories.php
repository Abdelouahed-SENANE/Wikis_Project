    ...
    <div class="flex flex-col gap-5 lg:flex-row lg:items-center">
        <aside class="w-full  p-3 lg:w-[200px] shadow-lg rounded-lg">
            ...
            <ul class="my-10">
                ...
                <li class="my-3 ml-2 hover:text-primary hover:bg-slate-100 p-2 rounded-md">
                    <a href="<?= URLROOT ?>/visitor/categories" class="flex gap-1.5 items-center hover:text-primary">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
                ...
                <li class="flex gap-1 items-center ml-2 hover:text-primary hover:bg-slate-100 p-2 rounded-md">
                    <a href="<?= URLROOT ?>/visitor/article" class="flex gap-1.5 items-center group  hover:text-primary">
                ...
                <li class="flex gap-1 items-center ml-2 hover:text-primary hover:bg-slate-100 p-2 rounded-md">
                    <a href="<?= URLROOT ?>/visitor/tags" class="flex gap-1.5 items-center group  ">
